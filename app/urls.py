...
from app.views import account, home, project, statistics, wiki, file, setting, issues, dashboard
...
urlpatterns = [
    ...
    path('payment/success/', home.payment_success, name='payment_success'),
